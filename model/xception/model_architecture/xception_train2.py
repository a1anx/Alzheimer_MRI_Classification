...
metrics_path = os.path.join(run_output_dir, 'xception_metrics.txt')
with open(metrics_path, 'w') as f:
    f.write("xception Model Evaluation Metrics\n")
    f.write("=" * 50 + "\n\n")
...
model_path = os.path.join(run_output_dir, 'xception_final.h5')
...
curves_path = os.path.join(run_output_dir, 'xception_training_curves.png')
...
plt.colorbar(im)
plt.tight_layout()
matrix_path = os.path.join(run_output_dir, 'xception_confusion_matrix.png')
