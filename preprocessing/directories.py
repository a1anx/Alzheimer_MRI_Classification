...
ROOT = '/Users/andykim/Documents/2025 Fall/NNDL/Project/NNDL_MRI_PROJECT'

# Pathname for initial Augmented Data folder (before running splitfolders)
INIT_INPUT = '/Users/andykim/Documents/2025 Fall/NNDL/Project/NNDL_MRI_PROJECT/Augmented Data'

# Pathname for MRI scan images in train, validation, and test sets in  (before running preprocessing)
TEST = '/Users/andykim/Documents/2025 Fall/NNDL/Project/NNDL_MRI_PROJECT/split_augmented_data/test'
